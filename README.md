...
2. **Wizard harassment parity**  
   Broaden Wizard of Yendor harassment beyond the current respawn/cached-respawn/respawn-boom/respawn-taunt/theft/curse/blind-silent-black-glow/group-enabled nasty-summon/level-teleport/off-screen-intervention/intervention-resurrection/intervention-aggravation/amulet-portal-sense-worn-or-wielded/live-taunt/blind-hears-taunts/visibility-and-range-gated-taunts/inactive-wizard-harassment-suppression runtime, with stronger cadence and more long-tail original-NetHack behavior.
