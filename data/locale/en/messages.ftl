...
opt-on = ON
opt-off = OFF
ui-options-game-title = Game Settings ({ $count } options)
ui-options-edit-prompt = { $option } [{ $current }]:
ui-oracle-menu-title = Consult the Oracle
ui-oracle-minor-option = Minor consultation (50 zorkmids)
...
ui-offer-prompt = Offer>
ui-confirm-quit = Really quit?
ui-save-failed = Save failed: { $error }
ui-save-create-dir-failed = Failed to create save directory: { $error }
ui-save-load-warning = Warning: failed to load save file: { $error }
ui-save-load-new-game = Starting a new game.
ui-commands-title = Commands
ui-here-commands-title = Commands For Here
ui-there-commands-title = Commands For There
ui-direction-prompt = In what direction?
ui-direction-prompt-optional = In what direction? (Esc for none)
ui-direction-prompt-run = Run in what direction?
...
ui-count-prefix = Count
ui-recording-start = Recording session to: { $path }
ui-recording-saved = Session recorded to: { $path }
ui-recording-save-warning = Warning: failed to save recording: { $error }
...
ui-text-status-line = Dlvl:{ $depth }  { $hp }  T:{ $turn }  Pos:{ $pos }  [hjklyubn=move .=wait <=up >=down q=quit ?=help]
ui-startup-loaded-filesystem = Loaded { $monsters } monsters, { $objects } objects from { $path }
ui-startup-loaded-embedded = Loaded { $monsters } monsters, { $objects } objects from embedded resources
ui-startup-language = Language: { $code } ({ $name })
ui-restored-save = Restored saved game: turn { $turn }, depth { $depth }.

option-label-autopickup = Autopickup
option-label-autodig = Auto-dig
option-label-autoopen = Auto-open
option-label-autoquiver = Auto-quiver
option-label-cmdassist = Command assist
option-label-confirm = Confirm dangerous actions
option-label-extmenu = Extended command menu
option-label-fireassist = Fire assist
option-label-fixinv = Fixed inventory letters
option-label-force-invmenu = Force inventory menu
option-label-lootabc = Alphabetic loot menu
option-label-number-pad = Number pad movement
option-label-pickup-stolen = Pick up stolen items
option-label-pickup-thrown = Pick up thrown items
option-label-pushweapon = Push previous weapon
option-label-quick-farsight = Quick farlook
option-label-rest-on-space = Space rests
option-label-safe-pet = Safe pet movement
option-label-safe-wait = Safe wait
option-label-sortpack = Sort pack
option-label-travel = Travel pathfinding
option-label-verbose = Verbose messages
option-label-autopickup-types = Autopickup types
option-label-menustyle = Menu style
option-label-pile-limit = Pile limit
option-label-runmode = Run mode
option-label-sortloot = Loot sorting
option-label-color = Color display
option-label-dark-room = Dark room rendering
option-label-hilite-pet = Highlight pets
option-label-hilite-pile = Highlight piles
option-label-lit-corridor = Lit corridors
option-label-sparkle = Sparkle effects
option-label-standout = Standout mode
option-label-use-inverse = Inverse highlight
option-label-hitpointbar = Hit point bar
option-label-showexp = Show experience
option-label-showrace = Show race
option-label-showscore = Show score
option-label-time = Show time
option-label-fruit = Favorite fruit
option-label-name = Character name
option-label-packorder = Pack order
option-label-tombstone = Tombstone screen
option-label-mail = Mail notifications

option-value-traditional = Traditional
option-value-combination = Combination
option-value-full = Full
option-value-partial = Partial
option-value-teleport = Teleport
option-value-run = Run
option-value-walk = Walk
option-value-crawl = Crawl
option-value-none = None
option-value-loot = Loot only
...
priest-ale-gift = The priest gives you { $amount } zorkmids for ale.
priest-cheapskate = The priest eyes your meager donation skeptically.
...
priest-cranky-2 = The priest snaps: "Talk? Here is what I have to say!"
priest-cranky-3 = The priest says: "Pilgrim, I would speak no longer with thee."
...
ui-item-prompt-wear = Wear what? [a-zA-Z or ?*]
ui-item-prompt-take-off = Take off what? [a-zA-Z or ?*]
ui-item-prompt-put-on = Put on what? [a-zA-Z or ?*]
ui-item-prompt-remove = Remove what? [a-zA-Z or ?*]
ui-item-prompt-apply = Apply what? [a-zA-Z or ?*]
ui-item-prompt-ready = Ready what? [a-zA-Z or ?*]
ui-item-prompt-throw = Throw what? [a-zA-Z or ?*]
ui-item-prompt-zap = Zap what? [a-zA-Z or ?*]
ui-item-prompt-invoke = Invoke what? [a-zA-Z or ?*]
ui-item-prompt-rub = Rub what? [a-zA-Z or ?*]
ui-item-prompt-tip = Tip what? [a-zA-Z or ?*]
ui-item-prompt-offer = Offer what? [a-zA-Z or ?*]
ui-item-prompt-force-lock = Force lock with what? [a-zA-Z or ?*]
ui-item-prompt-dip = Dip what? [a-zA-Z or ?*]
ui-item-prompt-dip-into = Dip into what? [a-zA-Z or ?*]
ui-item-prompt-name-item = Name which item? [a-zA-Z or ?*]
ui-item-prompt-adjust-item = Adjust which item? [a-zA-Z or ?*]
ui-text-prompt-wish = Wish for what?
ui-text-prompt-create-monster = Create which monster?
ui-text-prompt-teleport-level = Teleport to which dungeon level?
ui-text-prompt-annotate-level = Annotate this level with:
ui-text-prompt-engrave = Engrave what?
ui-text-prompt-call-class = Call which class letter?
ui-text-prompt-call-name = Call it what?
ui-text-prompt-known-class = Known which class letter?
ui-text-prompt-cast-spell = Cast which spell letter?
ui-text-prompt-name-target = Name target ([i]tem/[m]onster/[l]evel)?
ui-text-prompt-name-level = Name this level:
ui-text-prompt-call-monster = Call this monster what?
ui-text-prompt-name-it = Name it what?
ui-text-prompt-assign-inventory-letter = Assign new inventory letter:
ui-position-prompt-travel = Travel to where?
ui-position-prompt-jump = Jump to where?
ui-position-prompt-inspect = Inspect which position?
ui-position-prompt-look = Look at which position?
ui-position-prompt-name-monster = Name which monster position?
ui-equipment-slot-weapon = Weapon
ui-equipment-slot-off-hand = Off-hand
ui-equipment-slot-helmet = Helmet
ui-equipment-slot-cloak = Cloak
ui-equipment-slot-body-armor = Body armor
ui-equipment-slot-shield = Shield
ui-equipment-slot-gloves = Gloves
ui-equipment-slot-boots = Boots
ui-equipment-slot-shirt = Shirt
ui-equipment-slot-ring-left = Ring (left)
ui-equipment-slot-ring-right = Ring (right)
ui-equipment-slot-amulet = Amulet
ui-game-over-title = *** GAME OVER ***
ui-game-over-score-line = Score: { $score }
ui-game-over-cause-line = Cause: { $cause }
ui-game-over-turns-line = Turns: { $turns }
ui-extcmd-desc-hash = enter and perform an extended command
ui-extcmd-desc-question = list all extended commands
ui-extcmd-desc-apply = apply (use) a tool
ui-extcmd-desc-cast = zap (cast) a spell
ui-extcmd-desc-chat = talk to someone
ui-extcmd-desc-close = close a door
ui-extcmd-desc-dip = dip an object into something
ui-extcmd-desc-drop = drop an item
ui-extcmd-desc-eat = eat something
ui-extcmd-desc-fight = attack in a direction
ui-extcmd-desc-glance = show what a map symbol is
ui-extcmd-desc-inventory = show your inventory
ui-extcmd-desc-jump = jump to a location
ui-extcmd-desc-kick = kick something
ui-extcmd-desc-loot = loot a container or monster
ui-extcmd-desc-look = describe what is here
ui-extcmd-desc-open = open a door
ui-extcmd-desc-offer = offer a sacrifice
ui-extcmd-desc-pickup = pick up items here
ui-extcmd-desc-pray = pray to your god
ui-extcmd-desc-quiver = ready ammunition for firing
ui-extcmd-desc-quit = quit the game
ui-extcmd-desc-save = save the game
ui-extcmd-desc-search = search for hidden things
ui-extcmd-desc-sit = sit down
ui-extcmd-desc-throw = throw an object
ui-extcmd-desc-travel = travel to a map location
ui-extcmd-desc-untrap = untrap something
ui-extcmd-desc-wear = wear a piece of armor
ui-extcmd-desc-whatis = describe a map symbol or location
ui-extcmd-desc-wield = wield a weapon
ui-extcmd-desc-zap = zap a wand
