...
2. **Wizard harassment parity**  
   Broaden Wizard of Yendor harassment beyond the current respawn/theft/curse/nasty-summon/level-teleport/off-screen-intervention/amulet-portal-sense/live-taunt runtime, with richer nasty pools, stronger cadence, and more long-tail original-NetHack behavior.
...
- [ ] Grow the story traversal matrix into a broader save/load plus drift-detection harness for economy, religion, and branch state beyond the current quest/endgame/shop/temple/sanctum/wizard/Medusa/Castle/Orcus/Fort-Ludios/Vlad/invocation-portal/wizard-intervention scenarios.
