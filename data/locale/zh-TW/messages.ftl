...
# TODO: translate
choke-no-longer-breathe = 你再也無法呼吸了。
...
# TODO: translate
container-put-in = 你把 { $item } 放進了 { $container }。
...
# TODO: translate
npc-squawk-nevermore = { $monster } 說道：「Nevermore!」
...
# TODO: translate
god-roars-suffer = 一個轟鳴的聲音咆哮道：「為你的褻瀆受苦吧！」
...
# TODO: translate
ambient-fountain-coins = 你聽到水滴落在硬幣上的聲音。
# TODO: translate
ambient-fountain-naiad = 你聽到水澤仙女拍水的聲音。
# TODO: translate
ambient-fountain-soda = 你聽到汽水噴泉般的聲響！
# TODO: translate
