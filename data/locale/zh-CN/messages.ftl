...
shop-price-bargain = "给你，{ $item }只要{ $price }枚金币，真是划算。"
shop-price-excellent-choice = "给你，{ $item }只要{ $price }枚金币，绝对是上佳之选。"
shop-price-finest-quality = "给你，{ $item }只要{ $price }枚金币，品质上乘。"
shop-price-gourmets-delight = "给你，{ $item }只要{ $price }枚金币，美食家的心头好！"
shop-price-painstakingly-developed = "给你，{ $item }只要{ $price }枚金币，匠心打造！"
...
# TODO: translate
shk-surcharge-greeting = { $shopkeeper } 说道：“你现在要付更高的价钱了，{ $honorific }。”
