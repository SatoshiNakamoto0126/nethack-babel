...
2. Expand Wizard of Yendor harassment parity beyond the current respawn/cached-respawn/respawn-taunt/theft/curse/group-enabled scaled nasty-summon/level-teleport/off-screen-intervention/intervention-resurrection/intervention-aggravation/amulet-portal-sense/live-taunt runtime and repeated regression coverage.
