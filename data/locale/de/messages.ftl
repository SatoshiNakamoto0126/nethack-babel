...
opt-on = AN
opt-off = AUS
ui-options-game-title = Spieleinstellungen ({ $count } Optionen)
...
ui-offer-prompt = Angebot>
ui-confirm-quit = Wirklich beenden?
ui-save-failed = Speichern fehlgeschlagen: { $error }
ui-save-create-dir-failed = Speicherverzeichnis konnte nicht erstellt werden: { $error }
ui-save-load-warning = Warnung: Spielstand konnte nicht geladen werden: { $error }
ui-save-load-new-game = Starte ein neues Spiel.
ui-commands-title = Befehle
ui-here-commands-title = Befehle fuer hier
ui-there-commands-title = Befehle fuer dort
ui-direction-prompt = In welche Richtung?
ui-direction-prompt-optional = In welche Richtung? (Esc fuer keine)
ui-direction-prompt-run = In welche Richtung laufen?
...
ui-count-prefix = Anzahl
ui-recording-start = Sitzung wird aufgezeichnet nach: { $path }
ui-recording-saved = Sitzung aufgezeichnet in: { $path }
ui-recording-save-warning = Warnung: Aufzeichnung konnte nicht gespeichert werden: { $error }
...
ui-text-status-line = Stufe:{ $depth }  { $hp }  Zug:{ $turn }  Pos:{ $pos }  [hjklyubn=bewegen .=warten <=hoch >=runter q=beenden ?=hilfe]
ui-startup-loaded-filesystem = { $monsters } Monster und { $objects } Objekte aus { $path } geladen
ui-startup-loaded-embedded = { $monsters } Monster und { $objects } Objekte aus eingebetteten Ressourcen geladen
ui-startup-language = Sprache: { $code } ({ $name })
ui-restored-save = Spielstand wiederhergestellt: Zug { $turn }, Tiefe { $depth }.

option-label-autopickup = Automatisch aufheben
...
shk-angry-rude = { $shopkeeper } deutet an, wie sehr unhöfliche Kunden missfallen.
shk-angry-rude-indicates = { $shopkeeper } deutet an, wie sehr unhöfliche Kunden missfallen.
shk-angry-non-paying = { $shopkeeper } deutet an, wie sehr nichtzahlende Kunden missfallen.
shk-angry-non-paying-indicates = { $shopkeeper } deutet an, wie sehr nichtzahlende Kunden missfallen.
