...
fn run_tui_mode(
    ...
    app.messages_i18n = TuiMessages {
        ...
        item_prompt_take_off: locale.translate("ui-item-prompt-take-off", None),
        item_prompt_put_on: locale.translate("ui-item-prompt-put-on", None),
        item_prompt_remove: locale.translate("ui-item-prompt-remove", None),
        item_prompt_apply: locale.translate("ui-item-prompt-apply", None),
        item_prompt_ready: locale.translate("ui-item-prompt-ready", None),
        item_prompt_throw: locale.translate("ui-item-prompt-throw", None),
        item_prompt_zap: locale.translate("ui-item-prompt-zap", None),
        item_prompt_invoke: locale.translate("ui-item-prompt-invoke", None),
        item_prompt_rub: locale.translate("ui-item-prompt-rub", None),
        item_prompt_tip: locale.translate("ui-item-prompt-tip", None),
        item_prompt_offer: locale.translate("ui-item-prompt-offer", None),
        item_prompt_force_lock: locale.translate("ui-item-prompt-force-lock", None),
        item_prompt_dip: locale.translate("ui-item-prompt-dip", None),
        item_prompt_dip_into: locale.translate("ui-item-prompt-dip-into", None),
        item_prompt_name_item: locale.translate("ui-item-prompt-name-item", None),
        item_prompt_adjust_item: locale.translate("ui-item-prompt-adjust-item", None),
        text_prompt_wish: locale.translate("ui-text-prompt-wish", None),
        text_prompt_create_monster: locale.translate("ui-text-prompt-create-monster", None),
        text_prompt_teleport_level: locale.translate("ui-text-prompt-teleport-level", None),
        text_prompt_annotate_level: locale.translate("ui-text-prompt-annotate-level", None),
        text_prompt_engrave: locale.translate("ui-text-prompt-engrave", None),
        text_prompt_call_class: locale.translate("ui-text-prompt-call-class", None),
        text_prompt_call_name: locale.translate("ui-text-prompt-call-name", None),
        text_prompt_known_class: locale.translate("ui-text-prompt-known-class", None),
        text_prompt_cast_spell: locale.translate("ui-text-prompt-cast-spell", None),
        text_prompt_name_target: locale.translate("ui-text-prompt-name-target", None),
        text_prompt_name_level: locale.translate("ui-text-prompt-name-level", None),
        text_prompt_call_monster: locale.translate("ui-text-prompt-call-monster", None),
        text_prompt_name_it: locale.translate("ui-text-prompt-name-it", None),
        text_prompt_assign_inventory_letter: locale
            .translate("ui-text-prompt-assign-inventory-letter", None),
        position_prompt_travel: locale.translate("ui-position-prompt-travel", None),
        position_prompt_jump: locale.translate("ui-position-prompt-jump", None),
        position_prompt_inspect: locale.translate("ui-position-prompt-inspect", None),
        position_prompt_look: locale.translate("ui-position-prompt-look", None),
        position_prompt_name_monster: locale.translate("ui-position-prompt-name-monster", None),
    };
    let map = &world.dungeon().current_level;
