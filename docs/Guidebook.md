...
2. Expand Wizard of Yendor harassment parity beyond the current respawn/theft/curse/scaled nasty-summon/level-teleport/off-screen-intervention/amulet-portal-sense/live-taunt runtime and repeated regression coverage.
...
- [ ] Extend Wizard of Yendor harassment parity beyond the current respawn, theft, cursing, scaled nasty summon, level teleport, off-screen intervention, amulet portal sensing, live taunts, and repeated reload coverage.
